...
if __name__ =='__main__':
    ...
    parser.add_argument("--output_dir",help="Output directory for mesh",default=os.getcwd())
    ...
    main(swc_file,meshfile,output_dir,args.min_faces,args.min_dfaces)
